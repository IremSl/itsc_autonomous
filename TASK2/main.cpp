...
// there are no such types as short float, long long float, unsigned float, or unsigned double.
...
cout<<"Lower limit of short int: "<< numeric_limits<short int>::min()<<endl;
cout<<"Upper limit of int: "<< numeric_limits<short int>::max()<<endl;
cout<<"Lower limit of long long int: "<< numeric_limits<long long int>::min()<<endl;
cout<<"Upper limit of int: "<< numeric_limits<long long int>::max()<<endl;
cout<<"Lower limit of unsigned int: "<< numeric_limits<unsigned int>::min()<<endl;
cout<<"Upper limit of int: "<< numeric_limits<unsigned int>::max()<<endl;
cout<<"Lower limit of float: "<< numeric_limits<float>::min()<<endl;
cout<<"Upper limit of float: "<< numeric_limits<float>::max()<<endl;
cout<<"Lower limit of double: "<< numeric_limits<double>::min()<<endl;
cout<<"Upper limit of double: "<< numeric_limits<double>::max()<<endl;
cout<<"Lower limit of long double: "<< numeric_limits<long double>::min()<<endl;
cout<<"Upper limit of long double: "<< numeric_limits<long double>::max()<<endl;

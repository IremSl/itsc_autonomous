 ...
 if (cin.fail()) {
        ...
        if (choice == 1) {
         ...
         if (category == "starters") {
            ...
            cout << "Enter item index: ";
            cin >> itemIndex;
            cout << "Would you like your starter to be served cold or hot ? (C/H): ";
            char temp;
            ...
            while(true){
              ...
              cin >> temp;
                  ...
                  if (temp =='C'|| temp == 'c'|| temp == 'H' || temp =='h'){

                  TempType tempType = (temp =='C'|| temp == 'c') ? TempType::Cold : TempType::Hot;
                  sleep(1);

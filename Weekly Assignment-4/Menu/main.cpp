...
int main() {
    ...
    while (true) {
        ...
        cout << "1. See the menu\n";
        cout << "2. Add item to your menu\n";
        cout<<"3. Remove item from your  menu \n";
        cout<<"4. Get menu suggestion\n";
        cout<<"5. Create Menu by Taste Balances\n";
        ...
        if (choice == 1) {
         ...
         if(category=="main_courses"){
           ...
           cout<<"('Vegetable Stir-Fry' and 'Pesto Pasta' are the vegetarian main courses.)\n";
         ...
         if (category == "starters") {
          ...
          if (category == "salads") {
            ...
            cout << "Enter item index: ";
            cin >> itemIndex;
            cout << "Would you like to add a topping to your salad ? (yes/no): ";
            string response;
        ...
        cout << "Your drink has been added to the custom menu.\n";
